          ...
          <CardContent className="space-y-8 p-8">
            ...
            {!isRegister && !isForgotPassword && (
              <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg border border-blue-100">
                <p className="text-sm font-medium text-gray-800 mb-3">🚀 Demo Credentials for {activeTab.charAt(0).toUpperCase() + activeTab.slice(1)}:</p>
                <div className="space-y-2">
                  {demoCredentials[activeTab]?.map((cred, index) => (
                    <div key={index} className="flex justify-between items-center text-xs bg-white/50 p-2 rounded border">
                      <div>
            ...
            {isForgotPassword ? (
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="email-desktop" className="text-sm text-gray-700">Email Address</Label>
                    <Input
                      id="email-desktop"
                      name="email"
                      type="email"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="password-desktop" className="text-sm text-gray-700">Password</Label>
                    <div className="relative">
                      <Input
                        id="password-desktop"
                        name="password"
                  ...
                  {isRegister && (
                    <div className="space-y-2">
                      <Label htmlFor="confirmPassword-desktop" className="text-sm text-gray-700">Confirm Password</Label>
                      <div className="relative">
                        <Input
          ...
          <div className="text-center space-y-4">
            ...
            <div className="flex items-center justify-center space-x-4">
              ...
              <div className="w-12 h-12 bg-gradient-to-br from-green-100 to-green-200 rounded-xl flex items-center justify-center">
                <Stethoscope className="w-6 w-6 text-[#4ade80]" />
              </div>
